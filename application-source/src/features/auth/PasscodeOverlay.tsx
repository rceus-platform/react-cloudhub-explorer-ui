/**
 * Passcode Overlay Feature Module
 *
 * Responsibilities:
 * - Render a secure PIN entry interface for application unlocking
 * - Handle input focus management and auto-submission
 *
 * Boundaries:
 * - Does not handle the actual verification logic (delegated to onVerify prop)
 */
...
/** Interface for secure PIN-based entry and application unlocking */
